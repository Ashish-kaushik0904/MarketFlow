        ...
        <div className='container mb-5'>
            <div className='row'>
                ...
                <div className='col-6 mb-5'>
                    ...
                    <p>Varsity, the largest online stock market education book in the world covering everythings from the basics to advance trading.</p>
                    <a href='' className='mx-4' style={{textDecoration:"none"}}>Versity <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
